...
function ContactCard({ contact, index }: { contact: typeof contacts[0]; index: number }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-cream/80 text-[11px] tracking-[0.2em] uppercase mt-2 font-body">
        {contact.role}
      </p>
      ...
      <div className="mt-8 space-y-3">
        <a
          ...
          className="block text-cream/65 text-[15px] font-body hover:text-cream transition-colors duration-500 hover-line w-fit"
        >
          {contact.email}
        </a>
        <a
          ...
          className="inline-flex items-center gap-2.5 text-cream/65 text-[15px] font-body hover:text-cream transition-colors duration-500"
        >
  ...
  return (
    <div className="bg-green-dark min-h-screen">
      <section className="pt-32 md:pt-40 pb-20 md:pb-32 px-6 md:px-12 max-w-[1400px] mx-auto">
        ...
        {/* Contact cards */}
        <div className="grid md:grid-cols-2 gap-14 md:gap-20 mt-10 md:mt-14 max-w-3xl">
